...
public class FinanceMatchReqServiceImpl implements FinanceMatchReqService {
    ...
    public Result dealFinanceMatch(FinanceMatchReq financeMatchReq,List<InvestMatchReq> resNoMatchInvestReqList,
        ...
        logger.debug("【准备进入融资撮合方法中】入参：financeMatchReq={},resNoMatchInvestReqList={},resMatchedInvestReqList={},resFinanceMatchResList={}",
                financeMatchReq,resNoMatchInvestReqList,resMatchedInvestReqList,resFinanceMatchResList);
